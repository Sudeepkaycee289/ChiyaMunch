...
const ItemsViewPage = () => {
  ...
  const filteredItems = items.filter((item: Item) => item.Category === category && item.paid); // Filter items that have been paid
  console.log(filteredItems); // Debugging line to check filtered items
  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="flex flex-row items-center justify-between p-2.5">
        ...
        <h1 className="flex-1 text-center text-lg font-bold">{category}Your Subscriptions</h1>
      </div>
      <div className="p-5">
